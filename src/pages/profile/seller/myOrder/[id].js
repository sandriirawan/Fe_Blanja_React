...
function MyOrder() {
  ...
  useEffect(() => {
    axios
      .get(`${process.env.REACT_APP_API_KEY}/orders/${usersId}`)
      .then((response) => {
  ...
  useEffect(() => {
    axios
      .get(`${process.env.REACT_APP_API_KEY}/orders/seller/${usersId}/get%20paid`)
      .then((response) => {
  ...
  useEffect(() => {
    axios
      .get(`${process.env.REACT_APP_API_KEY}/orders/seller/${usersId}/processed`)
      .then((response) => {
  ...
  useEffect(() => {
    axios
      .get(`${process.env.REACT_APP_API_KEY}/orders/seller/${usersId}/sent`)
      .then((response) => {
  ...
  useEffect(() => {
    axios
      .get(`${process.env.REACT_APP_API_KEY}/orders/seller/${usersId}/completed`)
      .then((response) => {
  ...
  useEffect(() => {
    axios
      .get(`${process.env.REACT_APP_API_KEY}/orders/seller/${usersId}/cancel`)
      .then((response) => {
  ...
  const handleProcessed = async (id) => {
    try {
      await axios.put(`${process.env.REACT_APP_API_KEY}/orders/${id}/processed`);
  ...
  const handleSent = async (id) => {
    try {
      await axios.put(`${process.env.REACT_APP_API_KEY}/orders/${id}/sent`);
      console.log("update successfully");
    } catch (error) {
      console.error("Error update :", error);
    }
